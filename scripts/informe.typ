...
#block(fill: rgb("#E7EFEE"), radius: 6pt, inset: 12pt, width: 100%)[
  ...
  #v(4pt)
  #text(size: 9.5pt, fill: muted)[Informe completo con TODOS los hallazgos y cómo arreglar cada uno, US\$29: responde este correo y te mandamos los datos de pago (tarjeta, PayPal o transferencia). O aplicamos los arreglos puntuales del informe por ti, desde US\$149. Trabajo extra o hallazgos que requieran rediseñar partes de la app se informan y cotizan aparte.]
]
#v(10pt)
#align(center)[
