...
#post(
  ...
  annotation: [La "anon key" puede ir en el navegador. La #mono[service_role] #hl[jamás]: salta todas tus reglas de acceso — con ella se puede leer, modificar o borrar tu base completa, con 3 líneas de código.],
